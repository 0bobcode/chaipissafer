...
function App() {
  ...
  const students = {
    'Bob': {
      ...
      'Certificate(s)': {
        1: 'Stanford Computer Science 101',
    ...
    'Max': {
      ...
      'Compsci': 'Harvard',
      'Certificates': {
        1: 'Introduction to Computer Science Stanford',
    ...
    'Ethan': {
      ...
      'Robotics': 'CMU',
      'Certificates': {
        1: 'MIT Robotics: Science and Systems',
    ...
    'Noah': {
      ...
      'Music': 'Berklee',
      'Certificates': {
        1: 'Music Production with Python',
    ...
    'Lucas': {
      ...
      'Certificates': {
        1: 'Sports Analytics with Python',
  ...
  // Normalize & filter students based on search input

  const filtered = Object.entries(students).filter(([name, data]) => {
    ...
    const certs = data.Certificates || data["Certificate(s)"];

    if (certs) {

      for (const cert of Object.values(certs)) {

        if (cert.toLowerCase().includes(searchLower)) return true;
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <input
        ...
        placeholder="Search student, program, or certificate..."
      ...
      <table border="1" cellPadding="8" style={{ borderCollapse: "collapse" }}>
        ...
        <tbody>
          ...
          {filtered.map(([name, data]) => {
            ...
            const { Certificates, "Certificate(s)": _c, age, grade, ...programs } = data;
              ...
              <tr key={name}>
                ...
                <td>
                  <ul style={{ margin: 0, paddingLeft: "15px" }}>
                    ...
                    {Object.entries(certs).map(([i, cert]) => (
                      <li key={i}>{cert}</li>
